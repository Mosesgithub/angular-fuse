public partial class MissionsList: Fuse.Controls.DockPanel
{
    ...
    internal void InitializeUX()
    {
        ...
        temp_eb8 = new Fuse.Reactive.EventBinding("callback0");
        ...
        temp_eb9 = new Fuse.Reactive.EventBinding("callback1");
        ...
        global::Fuse.Gestures.Clicked.AddHandler(temp, temp_eb8.OnEvent);
        temp.Font = YooStyle.YoobicF;
        temp.Behaviors.Add(temp5);
        temp.Behaviors.Add(temp6);
        temp.Behaviors.Add(temp_eb8);
        temp7.Width = 45f;
        temp7.Height = 45f;
        ...
        global::Fuse.Gestures.Clicked.AddHandler(temp1, temp_eb9.OnEvent);
        temp1.Font = YooStyle.YoobicF;
        temp1.Behaviors.Add(temp8);
        temp1.Behaviors.Add(temp9);
        temp1.Behaviors.Add(temp_eb9);
